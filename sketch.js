...
function setup() {
    ...
    tankerhead = new TankerHead(50,500,200,200);
    ball1= new Ball(300,100,75,75);
    ball2= new Ball(400,200,75,75);
    ball3= new Ball(500,150,75,75);
    ball4= new Ball(600,100,75,75);
